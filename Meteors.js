...
export default class MeteorScreen extends Component {
    ...
    render() {
        ...
        let meteor_arr = Object.keys(this.state.meteors).map(meteor_date => {
            return this. this.state.meteors[meteor_date]
        })
        let meteors = [].concat.apply([], meteor_arr);
        meteors.forEach(function(element) {
            let diameter = (element.estimated_diamter.kilometers.estimated_diameter_min + element.estimated_diamter.kilometers.estimated_diamter_max) / 2
